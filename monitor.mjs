...
const PULLBACK_CONTINUATION_MAX_DISTANCE_PCT = parseFloat(process.env.AUTO_TRADER_PULLBACK_CONTINUATION_MAX_DISTANCE_PCT || '3');
const PULLBACK_CONTINUATION_MIN_CHANGE_24H = parseFloat(process.env.AUTO_TRADER_PULLBACK_CONTINUATION_MIN_CHANGE_24H || '0.5');
const PULLBACK_CONTINUATION_MAX_CHANGE_24H = parseFloat(process.env.AUTO_TRADER_PULLBACK_CONTINUATION_MAX_CHANGE_24H || '10');
