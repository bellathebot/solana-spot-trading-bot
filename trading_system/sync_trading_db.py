...
def main() -> None:
    ...
    parser.add_argument('--db', default='/home/brimigs/.trading-data/trading.db', help='Path to SQLite database')
    parser.add_argument('--data-dir', default='/home/brimigs/.trading-data', help='Directory containing trading JSON/log files')
